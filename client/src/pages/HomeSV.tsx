...
const HomeSV = () => {
  ...
  const destinationDescription = 'Föreställ dig att stå på en dimmig bergstopp, promenera genom antika ruiner eller känna havsbrisen på en gyllene strand.';
  ...
  return (
    <div className="w-full font-sans text-dark bg-white overflow-hidden pt-[110px] md:pt-[110px] lg:pt-0">
            ...
            {/* Carousel Navigation Buttons */}
              <div className="flex justify-end mt-3">
                <div className="flex gap-1 shrink-0 mr-0 md:mr-16">
                  <button onClick={scrollPrevTours} aria-label="Föregående turer" className="w-[34px] h-[28px] bg-[#01888E] rounded-[14px_0_0_14px] flex items-center justify-center text-white hover:bg-[#003032] transition-colors">
                    <ChevronLeft size={16} />
                  </button>
                  <button onClick={scrollNextTours} aria-label="Nästa turer" className="w-[34px] h-[28px] bg-[#01888E] rounded-[0_14px_14px_0] flex items-center justify-center text-white hover:bg-[#003032] transition-colors">
      ...
      <section className="py-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 bg-white w-full">
        <div className="max-w-[1200px] mx-auto">
          <div className="mb-6">
            <span className="text-[11px] font-normal text-[#01888E] uppercase tracking-[0.15em] mb-2 block" style={{ fontFamily: 'Inter' }}>Nå ditt drömresmål</span>
            <h3 className="text-[34px] md:text-[40px] leading-[44px] text-[#003032] mb-3 font-bold" style={{ fontFamily: 'Inter' }}>
      ...
      <section className="py-10 relative w-full overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20" style={{ backgroundImage: `url(${explorebg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="max-w-[1200px] mx-auto relative z-10">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-6">
            ...
            <div className="flex justify-end mt-3">
              <div className="flex gap-1 shrink-0 mr-0 md:mr-16">
                <button onClick={scrollPrevStays} aria-label="Föregående boende" className="w-[34px] h-[28px] bg-[#01888E] rounded-[14px_0_0_14px] flex items-center justify-center text-white hover:bg-[#003032] transition-colors">
                  <ChevronLeft size={16} />
                </button>
                <button onClick={scrollNextStays} aria-label="Nästa boende" className="w-[34px] h-[28px] bg-[#01888E] rounded-[0_14px_14px_0] flex items-center justify-center text-white hover:bg-[#003032] transition-colors">
                  <ChevronLeft size={16} style={{ transform: 'rotate(180deg)' }} />
                </button>
              </div>
            </div>
                ...
                {item.featured ? (
                  <div className="relative rounded-[12px] overflow-hidden shadow-[0px_4px_16px_rgba(0,0,0,0.08)] cursor-pointer group">
                    <div className="relative w-full h-[240px] bg-gray-200">
                      ...
                      <button aria-label="Lägg till i önskelista" className="absolute top-3 right-3 w-8 h-8 rounded-full bg-white/30 backdrop-blur-sm flex items-center justify-center text-white hover:bg-white/50 transition">
          ...
          <div className="absolute left-0 right-0 bottom-0 translate-y-[45%] flex justify-center px-4 sm:px-6 z-10">
            <div className="bg-white max-w-3xl w-full md:w-[720px] mx-auto rounded-[24px] shadow-[0px_8px_32px_rgba(0,0,0,0.12)] px-8 py-10 md:px-12 md:py-12">
              <h3 className="text-center text-[#003032] font-bold text-[24px] md:text-[28px] leading-tight mb-5" style={{ fontFamily: 'Inter' }}>
                Låt oss skräddarsy din <span className="text-[#01888E]">drömresa</span> idag!
              </h3>
              <p className="text-center text-[13px] md:text-[14px] text-[#757575] leading-relaxed max-w-2xl mx-auto mb-8 px-2" style={{ fontFamily: 'Inter' }}>
                Lorem Ipsum är endast fyllnadstext från tryck- och typografibranschen. Lorem Ipsum har varit standardtext sedan 1500-talet, när en okänd typograf tog ett antal typer och blandade dem för att skapa ett typspecimen.
              </p>
      ...
      <section className="relative py-14 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20 overflow-hidden" style={{ backgroundImage: `url(${explorebg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="max-w-[1200px] mx-auto relative z-10">
          <div className="mb-8 text-center md:text-left">
            <span className="text-[11px] font-normal text-[#01888E] uppercase tracking-[0.15em] mb-2 block" style={{ fontFamily: 'Inter' }}>OMDÖMEN</span>
